...
public class catalogTest {
        ...
        @Test
        @DisplayName("Verify products are displayed on catalog page")
        void verify_products_displayed(){
            List<WebElement> products = wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(PRODUCT_CARD, 0));
            assertTrue(products.size() > 0, "At least one product should be displayed");
        }
        @Test
        @DisplayName("")
